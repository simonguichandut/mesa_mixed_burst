...
! ***********************************************************************
      ...
      subroutine store_pgstar_controls(s, ierr)
         ...
         s% Kipp_switch_to_Column_Depth = Kipp_switch_to_Column_Depth
         ...
         s% Kipp_column_max = Kipp_column_max
         s% Kipp_column_min = Kipp_column_min
         s% Kipp_lgL_max = Kipp_lgL_max
         s% Kipp_lgL_min = Kipp_lgL_min
         s% Kipp_mass_margin = Kipp_mass_margin
         s% Kipp_column_margin = Kipp_column_margin
